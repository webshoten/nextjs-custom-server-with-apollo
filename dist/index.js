...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    graphQl = new graphql_1.default(db_1.db);
                    return [4 /*yield*/, graphQl.apolloServer.start()];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
                ...
                case 3:
                    ...
                    app.use('/graphql', (0, cors_1.default)(), express_1.default.json(), (0, express4_1.expressMiddleware)(graphQl.apolloServer));
